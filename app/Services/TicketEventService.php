...
use App\Repositories\TicketEventRepositoryInterface;
use Illuminate\Http\JsonResponse;
use Symfony\Component\HttpFoundation\Response as HTTP_RESPONSE;

class TicketEventService extends Service
{

    private TicketEventRepositoryInterface $repository;

    public function __construct(
        TicketEventRepositoryInterface $repository,
    )
    {
